...
export default function TakeExam() {
    ...
    useEffect(() => {
        async function init() {
            ...
            if (existingSessionId) {
                ...
                const newSessionRes = await api.post('/exam-sessions', {
                    exam_id: examId,
    ...
    useEffect(() => {
        ...
        autosaveRef.current = setInterval(() => {
            if (sessionRef.current) {
                ...
                api.put(`/exam-sessions/${sessionRef.current.id}`, {
                    answers: answersArr,
    ...
    const handleFocusLoss = useCallback(async () => {
        ...
        await api.put(`/exam-sessions/${sessionRef.current.id}`, {
            focus_loss_count: focusRef.current,
                ...
                <div className="flex-1 flex flex-col max-w-4xl mx-auto px-6 py-8">
                    ...
                    <div className="flex items-center justify-between mt-6">
                        ...
                        {currentIndex < questions.length - 1 ? (
                            ...
                            <Button
                                onClick={() => { handleSubmit(false).catch(console.error); }}
